...
PlayerView.prototype = {
  ...
  render: function(){
    var self = this;
    $(this.tbody).empty();
    var sorted = this.players.sort(this.dynamicSort("score")).reverse()
    $(sorted).each(function(index, player) {
...
DefinitionView.prototype = {
  ...
  render: function(){
    var self = this;
    this.$picklist.empty();
    var shuffled_defs = this.shuffle($(this.definitions));
    $(shuffled_defs).each(function(index, definition) {
